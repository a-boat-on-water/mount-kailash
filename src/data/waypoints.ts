...
export const waypoints: Waypoint[] = [
  ...
  },
  {
    ...
    description: {
      en: 'First of four prostration points along the kora. Kailash appears to the northeast for the first time. Pilgrims prostrate toward the sacred peak here. 4790m.',
      zh: '转山四个朝拜处中的第一个。冈仁波齐首次出现在东北方。朝圣者在此向神山跪拜。海拔4790米。',
    },
  ...
  },
  {
    ...
    description: {
      en: 'A flat rest area at 4740m. Named after a legend where a merchant left a basin of gold here after realizing merit cannot be bought. Good views of Kailash.',
      zh: '海拔4740米的平坦休息区。传说大商人罗布桑布在此留下一盆黄金后悟到功德不可买卖。可观冈仁波齐。',
    },
  ...
  },
  {
    ...
    description: {
      en: 'Supply station with food and hot water at the foot of Chuku Monastery. Medical aid station nearby. 4800m.',
      zh: '曲古寺山下的补给站，有食物和热水。旁边设有医疗服务点。海拔4800米。',
    },
  ...
  },
  {
    ...
    description: {
      en: 'Second prostration point on the western approach. Kailash\'s dramatic west face is visible. Pilgrims prostrate here. ~4920m.',
      zh: '西侧进山路上的第二个朝拜处。可望冈仁波齐壮丽的西壁。朝圣者在此跪拜。约4920米。',
    },
  ...
  },
  {
    ...
    description: {
      en: 'Rest station named after Hayagriva (Horse-headed Wisdom King). Supply point with food, hot water and medical aid. ~4950m.',
      zh: '以马头明王命名的驿站。补给点，有食物、热水和医疗服务。约4950米。',
    },
  ...
  },
  {
    ...
    description: {
      en: 'Largest accommodation along the kora with 50+ rooms. Located below Drirapuk Monastery. Main overnight stop for Day 1. 5080m.',
      zh: '转山全程最大的住宿点，50多间房。位于止热寺下方。第一天主要住宿地。海拔5080米。',
    },
  ...
  // ===== STAGE 2: Drirapuk → Zutul Puk (D2, ~20km) =====
  {
    ...
    description: {
      en: 'Supply point west of the sky burial site. Food, hot water, medical aid. Last major resupply before Dolma La. ~5310m.',
      zh: '天葬台西侧的补给点。有食物、热水、医疗服务。翻越卓玛拉前最后的主要补给。约5310米。',
    },
  ...
  },
  {
    ...
    description: {
      en: 'The steep final climb to Dolma La begins here. 1.4km to the pass, ~170m elevation gain. Take it slow. ~5460m.',
      zh: '从此开始最后的陡坡攀爬。距山口1.4公里，爬升约170米。慢慢走。约5460米。',
    },
  ...
  },
  {
    ...
    description: {
      en: 'Highest point of the kora at 5630m! Adorned with prayer flags. Dedicated to Tara (Dolma). Crossing symbolizes death and rebirth. ⚠️ Go slow, watch for altitude sickness.',
      zh: '转山最高点！海拔5630米。挂满经幡，献给度母（卓玛）。翻越象征死亡与重生。⚠️ 慢行，注意高反。',
    },
  ...
  },
  {
    ...
    description: {
      en: 'First supply point after Dolma La. Food, hot water, medical aid. Rest and recover here. ~5220m.',
      zh: '翻完卓玛拉后第一个补给点。有食物、热水、医疗服务。在此休息恢复。约5220米。',
    },
  ...
  },
  {
    ...
    description: {
      en: 'Supply point in the Medicine Buddha Valley. Food, hot water, medical aid. Named after the healing Buddha. ~4950m.',
      zh: '药师佛沟中的补给点。有食物、热水、医疗服务。以药师佛命名。约4950米。',
    },
  ...
  // ===== STAGE 3: Zutul Puk → Darchen (D3, ~10.6km) =====
  {
    ...
    name: { en: 'Third Prostration Point', zh: '第三朝拜处（恰采岗）' },
    description: {
      en: 'Third prostration point on the eastern side. Last clear view of Kailash from the east. Pilgrims prostrate here.',
      zh: '东侧的第三个朝拜处。从东面最后清晰看到冈仁波齐的位置。朝圣者在此跪拜。',
    },
    coordinate: [81.34, 31.025],
    elevation: 4750,
    type: 'sacred',
